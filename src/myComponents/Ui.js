...
export default function Ui() {
    ...
    const [searchKeyWord, setSearchKeyWord] = useState("dogss");
                    ...
                    <div class="p-2 ">
                        ...
                        <div className='flex justify-between m-1  md:flex-row'>
                            <div className='w-6/12 justify-center flex flex-wrap overflow-auto '>
                                <div className='bg-slate-200 w-11/12 h-7 p-1 my-1 text-xs rounded-lg font-bold shadow-sm hover:bg-slate-300 active:bg-slate-400' onClick={() => gifSearchTogler == "none" ? setGifSearchTogler("") : setGifSearchTogler("none")}>
                                ...
                                <div className='absolute mt-9 w-40 md:w-2/12' style={{ display: gifSearchTogler }}>
                                    <div className=' backdrop-sepia-50 bg-cyan-500/80 p-1 rounded-md flex justify-center flex-col ' >
                                        <div className='justify-center flex '>
                                            <input className='font-bold w-20 md:w-50 rounded-md px-2' type="text" placeholder='GIF...' value={searchKeyWord} onChange={(e) => mySearch(e)} ></input>
                                        </div>
                        ...
                        <div className=' flex justify-center items-center flex-col bg-red-100 rounded-lg shadow-md'>
